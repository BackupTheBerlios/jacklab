...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/jacklab/Repository/gentoo/sys-process/rtirq/rtirq-20050914.ebuild,v 1.1 2006/04/10 11:35:53 gimpel Exp $
...
src_install(){
	cd  ${D}
	epatch "${FILESDIR}/rtirq-20050914-v0.1.bz2" || die
...
pkg_postinst(){
	...
	einfo "and of course you need an realtime-kernel:"
